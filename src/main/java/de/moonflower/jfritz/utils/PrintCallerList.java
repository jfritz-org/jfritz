...
//        log.debug("Create Columns"); //$NON-NLS-1$
...
//            log.debug(columnCount + " Columns"); //$NON-NLS-1$
//            for (int i = 0; i < columnCount; i++) {
//                String columnName = colModel.getColumn(i).getHeaderValue()
//                .toString();
...
//                    ElementAlignment.CENTER, ElementAlignment.MIDDLE, font,
//                    columnName);
//            log.debug("Column: " + columnName +  //$NON-NLS-1$
...
//
//        log.debug("Creating column widths ..."); //$NON-NLS-1$
//        createColumnWidths();
//
...
//            }
//        };
//        log.debug("Adding print field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding date field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding callbycall field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding number field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding name field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding port field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding route field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding duration field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding comment field ..."); //$NON-NLS-1$
...
//            }
//        };
//        log.debug("Adding picture field ..."); //$NON-NLS-1$
//        exp.setName("print_picture"); //$NON-NLS-1$
//        report.addExpression(exp);
//
//        log.debug("Creating renderer ..."); //$NON-NLS-1$
//        for (int i = 0; i < JFritz.getJframe().getCallerTable()
//                .getColumnCount(); i++) {
//
...
//
//            // Rand zeichnen
//            log.debug("Print border ..."); //$NON-NLS-1$
