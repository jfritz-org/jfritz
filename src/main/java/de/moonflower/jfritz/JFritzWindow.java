...
//					log.debug("Window resized");
	...
	private void createGUI() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(loadResource("images/tray16.png"))); //$NON-NLS-1$
...
//		statusPanels.add(createStatusBar(), BorderLayout.CENTER);
	...
	public StatusBar createStatusBar2() {
		...
		connectIcon = new ImageIcon(loadResource("images/connect.png")); //$NON-NLS-1$
		disconnectIcon = new ImageIcon(loadResource("images/disconnect.png")); //$NON-NLS-1$
		callMonitorConnectIcon = new ImageIcon(loadResource("images/monitor-up.png")); //$NON-NLS-1$
		callMonitorDisconnectIcon = new ImageIcon(loadResource("images/monitor-down.png")); //$NON-NLS-1$
...
//				UIManager.setLookAndFeel(info.getClassName());
	...
	public void printCallerList() {
		log.error("Printing of caller list is diabled!");
