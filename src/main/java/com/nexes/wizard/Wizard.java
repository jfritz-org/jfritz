...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
   ...
   /**
    ...
    private void initComponents() {
        ...
        backButton = new JButton(new ImageIcon("wizard/backIcon.gif"));
    ...
    static {
        ...
        try {
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("wizard/wizard");
            ...
            BACK_ICON = new ImageIcon(Wizard.class.getClassLoader().getResource("wizard/backIcon.gif"));
            NEXT_ICON = new ImageIcon(Wizard.class.getClassLoader().getResource("wizard/nextIcon.gif"));
            CANCEL_ICON = new ImageIcon(Wizard.class.getClassLoader().getResource("wizard/cancelIcon.gif"));
            FINISH_ICON = new ImageIcon(Wizard.class.getClassLoader().getResource("wizard/finishIcon.gif"));
