...
public interface BoxCallListInterface {
	...
	public Vector<Call> getCallerList(Vector<IProgressListener> callListProgressListener) throws IOException, MalformedURLException, FeatureNotSupportedByFirmware;
