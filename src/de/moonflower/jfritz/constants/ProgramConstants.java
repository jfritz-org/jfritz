...
public class ProgramConstants {
	...
	public final static String PROGRAM_VERSION = "0.7.4.1.27"; //$NON-NLS-1$

	public final static String REVISION = "208MP";

	public final static String BUILD_DATE = "11-10-2011 14:26:32";
}
