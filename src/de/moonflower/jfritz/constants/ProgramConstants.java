...
public class ProgramConstants {
	...
	public final static String PROGRAM_VERSION = "0.7.4.1.20"; //$NON-NLS-1$

	public final static String REVISION = "196MP";

	public final static String BUILD_DATE = "05-09-2011 01:28:41";
}
