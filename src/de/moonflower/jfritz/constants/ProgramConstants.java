...
public class ProgramConstants {
	...
	public final static String PROGRAM_VERSION = "0.7.4.1.21"; //$NON-NLS-1$

	public final static String REVISION = "198P";

	public final static String BUILD_DATE = "07-09-2011 22:56:22";
}
