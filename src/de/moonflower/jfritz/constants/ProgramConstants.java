...
public class ProgramConstants {
	...
	public final static String PROGRAM_VERSION = "0.7.4.1.22"; //$NON-NLS-1$

	public final static String REVISION = "198:199P";

	public final static String BUILD_DATE = "08-09-2011 00:05:44";
}
