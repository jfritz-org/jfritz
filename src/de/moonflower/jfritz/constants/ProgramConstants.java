...
public class ProgramConstants {
	...
	public final static String PROGRAM_VERSION = "0.7.4.1.25"; //$NON-NLS-1$

	public final static String REVISION = "203P";

	public final static String BUILD_DATE = "14-09-2011 20:38:26";
}
