...
public class Main implements LookupObserver {
	...
	public final static String PROGRAM_VERSION = "0.7.3.16"; //$NON-NLS-1$
	...
	public final static String CVS_TAG = "$Id: Main.java 43 2009-08-04 09:08:06Z robotniko $"; //$NON-NLS-1$
