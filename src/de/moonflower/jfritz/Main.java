...
public class Main implements LookupObserver {
	...
	public final static String PROGRAM_VERSION = "0.7.3.15"; //$NON-NLS-1$
	...
	public final static String CVS_TAG = "$Id: Main.java 42 2009-08-02 13:39:15Z robotniko $"; //$NON-NLS-1$
