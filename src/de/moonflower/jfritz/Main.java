...
public class Main implements LookupObserver {
	...
	public final static String PROGRAM_VERSION = "0.7.3.13"; //$NON-NLS-1$
	...
	public final static String CVS_TAG = "$Id: Main.java 36 2009-07-28 09:48:31Z robotniko $"; //$NON-NLS-1$
