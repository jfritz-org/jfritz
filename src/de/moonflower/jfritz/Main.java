...
public class Main implements LookupObserver {
	...
	public final static String PROGRAM_VERSION = "0.7.3.14"; //$NON-NLS-1$
	...
	public final static String CVS_TAG = "$Id: Main.java 40 2009-07-29 09:34:56Z robotniko $"; //$NON-NLS-1$
