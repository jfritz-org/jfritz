...
public class ProgramConstants {
	...
	public final static String PROGRAM_VERSION = "0.7.4.1.18"; //$NON-NLS-1$

	public final static String REVISION = "190MP";

	public final static String BUILD_DATE = "05-09-2011 00:46:41";
}
