...
//       'support@gerixsoft.com', 'IndieVolume Uninstall Feedback', 'Signature');
//   end;
// end;
//
[code]
...
function UninstallFeedback(FormCaption: String; 
  ...
  EmailAddress: String; EmailSubject: String; MessageSuffix: String): Boolean;
var
  Form: TSetupForm;
...
begin
  ...
  try
    ...
    begin
      Feedback := Trim(FeedbackMemo.Lines.Text + MessageSuffix);
      if Feedback <> '' then
      begin
