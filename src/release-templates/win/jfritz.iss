...
VersionInfoTextVersion={#AppVersion}.{#AppRevision}
VersionInfoProductVersion={#AppVersion}.0
VersionInfoProductTextVersion={#AppVersion}.{#AppRevision}
...
de.WrongJavaVersion1=Setup hat festgestellt dass Sie eine Java Version unter 1.7 benutzen, JFritz ben�tigt aber mindestens Java 1.7.
